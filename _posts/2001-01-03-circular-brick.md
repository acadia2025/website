---
layout: post
title:  "CIRCULAR BRICK: Performative Design for Robotic 3D-Printed Brick using Sargassum Biomaterials"
date:   2014-06-02
...
1. **Dried sargassum will be provided**, obtained as waste washed up on the shoreline
2. **The sargassum is pulverized**, to prepare it for introduction to the composition
3. **The sargassum is measured**, then we prepare the mix with ceramic kaolin and other organic binders
4. **The digital file is prepared**, from a Grasshopper file to KUKA SRC, to communicate with the robot
5. **The composition is mixed with water**, until the mixture has a plastic consistency
...
1. Individually crafted 3D-printed biomaterial blocks to take ownership of
